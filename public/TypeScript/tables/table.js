                    ...
                    Arrays.forEach((ArraysValue, indexOfArraysValue) => {
                        ...
                        for (let loopOfnumber = 0; loopOfnumber < patterns.length; loopOfnumber++) {
                            function winnerGame() {
                                ...
                                function isDrawGame(checkDraw, tieScore) {
                                    return checkDraw = tieScore == 9 ? true : false;
                                }
                                function showDraw(tieScore) {
