...
const updateTextScores = (): void => {
    const scoresDialog = document.querySelector("#scoresDialog") as HTMLParagraphElement;
...
const changeTextContinue = (): void => {
    const textContinueDialog = document.querySelector("#textContinueDialog") as HTMLHeadingElement;
...
const handleClosing = (): void => {
    ...
    const continueDialog = document.querySelector("#continueDialog") as HTMLElement;
...
export const handleNotificaiton = () => {
    ...
    const exitDialogWinner = document.querySelector("#exitDialogWinner") as HTMLButtonElement;
